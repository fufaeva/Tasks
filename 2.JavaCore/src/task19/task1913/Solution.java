...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        PrintStream stream = System.out; //запоминаем настоящий PrintStream в специальную переменную
        ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
        PrintStream steamNew = new PrintStream(byteArrayOutputStream);
        System.setOut(steamNew);
